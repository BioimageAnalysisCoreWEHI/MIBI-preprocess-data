...
summary_output_path = output_folder
```
...
valid_target = ["main-cell-type", "fm-markers-only", "fm-with-celltype"]
...
if target == "fm-with-celltype":
    expression_df = expression_df.loc[:, measurement_columns + cell_types]
else:
...
```{python}
#| label: print-labels-location
#| output: true

if "fm" in target:
    print(None)
else:
    print(os.path.join(summary_output_path, f"{batch_name}_cell_type_labels.csv"))
```

**Image list:**

```{python}
#| label: print-imagelist-location
#| output: true

print(os.path.join(summary_output_path, f"{batch_name}_images.csv"))
```

**Decoder:**

```{python}
#| label: print-decoder-location
#| output: true

if os.path.exists(os.path.join(output_folder, f"{batch_name}_decoder.json")):
    print(os.path.join(summary_output_path, f"{batch_name}_decoder.json"))
else:
    print(None)
```
...
```{python}
#| label: print-output-location
#| output: true

print(os.path.join(summary_output_path, f"{batch_name}_preprocessed_input_data.csv"))
```

**Binarized Classification Labels:**

```{python}
#| label: print-binarizedlabels-location
#| output: true
#| 
if "fm" in target:
    print(os.path.join(summary_output_path, f"{batch_name}_binarized_labels.csv"))
else:
    print(None)
```